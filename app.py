        ...
        if probability >= 70:
            ...
            st.error(
                ...
                **High Priority Customer**
                ...
                The retention team should review the identified risk factors
            ...
            st.warning(
                """
                **Moderate Priority Customer**

                This customer shows moderate churn risk.
                Continued engagement and targeted offers may help reduce risk.
                """
            )
            ...
            st.success(
                ...
                **Low Priority Customer**
                ...
                Normal customer engagement can continue.
                """
            )
